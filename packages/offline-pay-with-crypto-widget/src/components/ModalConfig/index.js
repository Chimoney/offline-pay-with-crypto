      ...
      <Box sx={{ my: 4 }}>
        <Container sx={{ boxShadow: 2, p: 3 }} maxWidth="md">
          ...
          <TextField
            ...
            placeholder="https://"
            value={storeImg}
            onChange={(e) => setStoreImg(e.target.value)}
            fullWidth
                  ...
                  <Stack direction="row" mt={3} spacing={2}>
                    <FormControl sx={{ width: '100%' }}>
                      <TextField
                        ...
                        onChange={handleSupportedCurrChange(
                          curr?.code,
                          'walletAddress'
                        )}
                        fullWidth
          ...
          <Stack direction="row" mt={6} spacing={2}>
            ...
            <Box
              ...
              sx={{ width: '100%' }}
            >
              <Button onClick={addSupportedCurrency} variant="contained">
          ...
          <Box
            ...
            sx={{ m: 2 }}
          >
            <Button onClick={generatePaymentLink} variant="contained">
              Generate Payment Link{' '}
            </Button>
          </Box>
        </Container>
